...
namespace read_d2c_messages
{
    class ReadDeviceToCloudMessages
    {
        ...
        private readonly static string s_eventHubsCompatibleEndpoint = "sb://iothub-ns-ytiotopenh-891479-6fa05c40d4.servicebus.windows.net/";

        // Event Hub-compatible name
        // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
        private readonly static string s_eventHubsCompatiblePath = "ytiotopenhackhub";
        
        // az iot hub policy show --name iothubowner --query primaryKey --hub-name {your IoT Hub name}
        private readonly static string s_iotHubSasKey = "J/9vkyBW+nCpMKvJmfGcX8JGeInzpr+OYrTCtn+ioWg=";
